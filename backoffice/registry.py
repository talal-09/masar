...
RESOURCES = (
    ...
    Resource("work-orders", WorkOrder, "◫", "الصيانة", ("id", "customer", "vehicle", "branch", "status", "scheduled_at"), ("id", "customer__full_name", "vehicle__plate_number", "description"), ("customer", "vehicle", "branch", "assigned_technician"), form_fields=("branch", "customer", "vehicle", "created_by", "description", "mileage", "status", "scheduled_at", "center_notes", "assigned_technician", "started_at", "completed_at")),
